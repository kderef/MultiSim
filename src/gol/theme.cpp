...
namespace GOL_Theme {
    ...
    struct ThemeStyle {
        ...
        constexpr ThemeStyle() :
            bg_color(COLOR_NONE), fg_color(COLOR_NONE),
            ac_color(COLOR_NONE), bg_char_color(COLOR_NONE),
            bg_char(""), fg_char(""), name("") {}
        ...
        constexpr ThemeStyle(
            ...
            bg_char(bg_char_), fg_char(fg_char_), name(name_)
        {}
    };
    ...
    static inline void theme_toggle_bolus(Theme* theme) {
        *theme = (*theme == Theme::Bolus)? Theme::Default : Theme::Bolus;
    }

    static inline void theme_cycle(Theme* theme) {
        *theme = (*theme == Theme::Bolus)?
            Theme::Default : ((*theme) + 1 == Theme::Bolus)?
                Theme::Bolus : (Theme)((*theme) + 1);
    }
